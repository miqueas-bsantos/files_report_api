    ...
    def reprocess(self, files) -> Dict:
        ...
        try:
                ...
                "notificationItems":[
                    {
                        "NotificationRequestItem": {
                            ...
                            "reason":"https://ca-live.adyen.com/reports/download/MerchantAccount",
                            "success": True
                        }
                    }
                ]
            ...
            for filename in files.files:
                ...
                structure["notificationItems"][0]["NotificationRequestItem"]["reason"] = f"https://ca-live.adyen.com/reports/download/MerchantAccount/{files.merchantCode}/{filename}"
